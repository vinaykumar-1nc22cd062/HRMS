    ...
    <section class="invoice" id="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          From
          <address>
            <strong>NAGARJUNA GROUP OF INSTITUTIONS</strong><br>
            NCET<br>
            near beedaganahalli,venkatagiri kote (post) <br>
            devanahalli,bengaluru<br>
            karnataka - 562110 <br>

            Website: www.ncet.co.in<br>
            Email: principal@ncetmail.com
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          Dear <?php echo $cnt['staff_name']; ?>, Our institution has just processed your payments. Your payment has been deposited electronically in your account on <?php echo date('d-m-Y', strtotime($cnt['added_on'])); ?>
          </p>
        </div>
        <!-- /.col -->
        <div class="col-xs-6">
